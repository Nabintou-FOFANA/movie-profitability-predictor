...
import MLModelPage from './components/MLModel/MLModelPage';
      ...
      <nav className="bg-gray-900 bg-opacity-95 backdrop-blur-md border-b border-gray-800 sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            {/* GitHub Link */}
            <a
                href="https://github.com/Nabintou-FOFANA/movie-profitability-predictor"
                target="_blank"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="text-gray-400 text-sm text-center md:text-left">
              ...
              <p className="mt-1">Dataset : TMDB • 7,632 films • 1980-2023</p>
            </div>
          ...
          <div className="bg-gradient-to-b from-gray-800/50 to-gray-900 py-20">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="text-center mb-16">
                <div className="inline-block bg-amber-600/10 border border-amber-600/20 rounded-lg px-4 py-2 mb-6">
                  <span className="text-amber-400 font-semibold">👥 L'Équipe</span>
                </div>
                <h2 className="text-3xl sm:text-4xl font-bold mb-4">
                  Notre Équipe
                </h2>
                <p className="text-gray-400 max-w-2xl mx-auto">
                  Étudiants en Master 2 MIAGE passionnés par l'analyse cinématographique
                </p>
              </div>

              <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                {[
                  { name: 'Hawa DIALLO', role: 'Data Scientist' },
                  { name: 'Hiba LOUZZANI', role: 'Data Scientist' },
                  { name: 'Nabintou FOFANA', role: 'Data Scientist' },
                  { name: 'Oumar MAHAMAT', role: 'Data Scientist' }
                ].map((member, index) => (
                    <div key={index} className="bg-gray-900/50 border border-gray-800 rounded-xl p-6 text-center hover:border-red-600/50 transition-all group">
                      <div className="w-20 h-20 bg-gradient-to-br from-red-600 to-amber-600 rounded-full mx-auto mb-4 flex items-center justify-center text-2xl font-bold group-hover:scale-110 transition-transform">
